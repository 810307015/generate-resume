...
function ScrollBar(props) {
  ...
  const handleMouseMove = (e) => {
    ...
    const { conHeight } = currentWH;
    const deltaY = e.clientY - startY;
    console.log(e.clientY, startY, deltaY, yTop);
  ...
  return (
    <div className="ScrollBar" style={{ width, height }} ref={containerRef} onMouseMove={(e) => { e.persist(); debounce(handleMouseMove)(e); }} onMouseUp={handleMouseUp}>
