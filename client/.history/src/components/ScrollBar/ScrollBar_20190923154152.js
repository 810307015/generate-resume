...
function ScrollBar(props) {
  ...
  return (
    <div className="ScrollBar" style={{ width, height }} ref={containerRef} onMouseMove={(e) => { e.persist(); e.stopPropagation(); e.preventDefault(); debounce(handleMouseMove)(e); }} onMouseUp={handleMouseUp}>
